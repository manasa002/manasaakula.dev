...
<ul>
  ...
  <li><b>Frameworks & Libraries:</b> React, Flutter, React Native</li>
  <li><b>Styling & UI:</b> HTML5, CSS3, Sass, Tailwind CSS, Bootstrap, Responsive Design (Media Queries)</li>
  <li><b>Frontend Development:</b> Responsive design, Clean & maintainable code, Component-based architecture, Performance optimization</li>
  <li><b>Tools & Platforms:</b> Git, GitHub, VS Code, AEM, Android Studio</li>
  <li><b>API & Testing Tools:</b> Postman, Altair</li>
</ul>
<h2>Contact</h2>
<ul>
  <li class="dot">📧 Gmail: <a href="mailto:akulamanasa2002@gmail.com">akulamanasa2002@gmail.com</a></li>
